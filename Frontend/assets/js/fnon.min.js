          ...
          (s = function (e) {
              ...
              L =
                (a(
                  (t = {
                    ...
                    closeButton: !0,
                    animation: "slide-top",
                    autoFocusTag: "input:not([disabled])",
                    autoFocus: !1,
                    autoFocusDelay: 0,
                  }),
                  "closeButton",
            ...
            function B(e) {
              (e.style.pointerEvents = "none"),
                (e.style.opacity = 0),
                e.remove(),
                !document.querySelectorAll("div.f__cm").length > 0 &&
            ...
            function A(e, t) {
                ...
                ? '<div class="f__m__f">'.concat(
                    e.buttons.reduce(function (e, t, n) {
                      ...
                      t.style &&
                        "Light" != t.style &&
                        T[t.style] &&
                        ((r.color = T[t.style].btnOkColor),
                        (r.background = T[t.style].btnOkBackground),
                        (r.borderColor = T[t.style].btnOkBorderColor));
                      var o = i(i({}, r), t);
                      return (
                        e +
                        '<button class="f__btn '
                          .concat(
                            null !== (a = o.css) && void 0 !== a ? a : "",
                            '" data-i="'
                          )
              ...
              var o = 'style="color:'.concat(e.titleColor, ';"'),
                c = '<div class="f__cm'
                  ...
                  .concat(
                    e.zIndex,
                    ';transition: width 2s;"><div class="f__m f__m__'
                  )
                  .concat(e.width, " ")
                  .concat(e.animation, '">')
                  .concat(
                  ...
                  .concat(a, '<div class="f__m__b__ask ')
                  .concat("dialogue" == t ? "" : "ico", '" styel="--color:')
                  .concat(e.color, '"></div></div>')
                  .concat(e.delButtons ? "" : n, "</div></div>"),
                s = (c = k(c)).querySelector(".f__m__b__ask");
              if (
                (e.message instanceof HTMLElement
                  ? s.append(e.message)
                  : (s.innerHTML = e.message),
                "alert" != t)
              ) {
                var l = c.querySelectorAll('[data-evt="ccl"]');
                if (
                  (l &&
                        ...
                        ? n.addEventListener("click", function (t) {
                            if (
                              ...
                              var n = e.cancelCallback(
                                ...
                                c.querySelector("div.f__m__b__ask"),
                                t
                              );
                              (null != n && !0 !== n) || B(c);
                            } else B(c);
                  ...
                  c.querySelectorAll(".f__m__f button").forEach(function (t) {
                  ...
                  var d = c.querySelector('[data-evt="tr"]');
                  d &&
                    d.addEventListener("click", function (n) {
                      if (e.callback && "function" == typeof e.callback)
                        if ("dialogue" == t) {
                          ...
                          (null != a && !0 !== a) || B(c);
                        } else e.callback(!0, n), B(c);
                      else B(c);
                    });
                }
              } else {
                var u = c.querySelectorAll('[data-al="true"]');
              ...
              e.defaultBefore &&
                "function" == typeof e.defaultBefore &&
                e.defaultBefore(c),
                e.beforeShow &&
                  "function" == typeof e.beforeShow &&
                  e.beforeShow(c);
              var f = c.querySelector('button[data-evt="max"]');
              if (
                (f &&
                  f.addEventListener("click", function () {
                    c.classList.contains("fl")
                      ? (c.classList.remove("fl"),
                        c.querySelector(".f__m").classList.remove("f__m__fl"))
                      : (c.classList.add("fl"),
                        c.querySelector(".f__m").classList.add("f__m__fl"));
                  }),
                document.body.classList.add("f__of_hidden"),
                document.body.appendChild(c),
                e.defaultAfter &&
                  "function" == typeof e.defaultAfter &&
                  e.defaultAfter(c),
                e.afterShow &&
                  "function" == typeof e.afterShow &&
                  e.afterShow(c),
                e.autoFocus)
              ) {
                var m = c.querySelector(e.autoFocusTag);
                m &&
                  setTimeout(function () {
                    return m.focus();
                  }, e.autoFocusDelay);
            ...
            Object.keys(P).forEach(function (e) {
              return (R[e] = function (t, n) {
                ...
                (v = h(a.svgColor, 9)),
                  (function (e, t, n) {
                    if (document.getElementById(q.cid))
                      x(
                        "Waiting Existed!",
                        "Waiting box is already existed. you need to call Change function instead."
                      );
                    else {
                      var a = t && "object" === r(t) ? i(i({}, q), t) : q,
                        o = "<div id="
                          .concat(q.cid, ' class="f f__cw" style="background:')
                          .concat(
                            a.background,
                            '"><div class="f__w" style="width:'
                          )
              ...
              (R.Change = function (e) {
                var t = document.getElementById(q.cid);
                if (t) {
                  ...
                  n
                    ...
                    : (((n = k(
                        '<p style="font-size:'
                          .concat(q.textSize, ";color:")
                          .concat(q.textColor, '"></p>')
                      )).innerHTML = e),
            ...
            return (
                    ...
                    (function (e, t, n, a) {
                      var o =
                        "object" === r(e)
                          ...
                          : null;
                      if (o) {
                        o.setAttribute("data-pos", o.style.position),
                          (o.style.position = "relative");
                        var c = n && "object" === r(n) ? i(i({}, F), n) : F,
                          s = '<div data-id="'
                            .concat(
                              F.cid,
                              '" class="f f__cb" style="background:'
                            )
                            .concat(
                              c.background,
              ...
              (I.Remove = function (e, t) {
                var n =
                  "object" === r(e)
                    ? e.querySelector('div[data-id="'.concat(F.cid, '"]'))
                    : "string" == typeof e
                    ? document.querySelector(
                        e + ' div[data-id="'.concat(F.cid, '"]')
                      )
                    : null;
                if (n) {
              ...
              { Ask: O, Alert: z, Dialogue: N, Hint: D, Wait: R, Box: I }
            );
          }),
